# Việt Hóa Wuthering Waves v2.0.1

Bản v2.0.1 hoàn thiện luồng cài đặt, cập nhật trực tiếp và bộ công cụ dịch của WAHU Community.
...
- Cải thiện màn hình khởi động WAHU Community.
- Khôi phục trang Đặt tên nhân vật; hỗ trợ riêng tên Anh, Hán Việt và tên tự đặt.
- Mặc định tải toàn bộ 64 nhân vật; đổi phiên bản sẽ tự cập nhật số câu có tên.
- Sửa kiểm tra QA để giảm lỗi giả về placeholder, nội dung và phiên bản.
