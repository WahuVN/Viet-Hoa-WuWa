...
public interface IFontService
{
    ...
    /// <summary>Đóng gói trực tiếp file font thô (.ttf/.otf/.ttc) thành Pak V12 và áp dụng vào game.</summary>
    Task<Result> BuildAndApplyCustomFontAsync(string gamePath, string rawFontPath, CancellationToken ct = default);
