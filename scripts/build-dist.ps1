...
$releaseZip = Join-Path $distRoot 'VietHoa-WuWa-v2.0.0.zip'
...
Write-Host "   -> Gui file VietHoa-WuWa-v2.0.0.zip cho nguoi khac; giai nen ra o dia roi chay 'Chay VHWuWa.bat'."
