...
$supportItems = @(
    ...
    @{ Source = (Join-Path $repoRoot 'wuwavh_tool\analysis\extracted_3.6\en\Client\Content\Aki\ConfigDB\en'); Target = 'analysis\extracted_3.6\en\Client\Content\Aki\ConfigDB\en' },
    @{ Source = (Join-Path $repoRoot 'wuwavh_tool\analysis\extracted_3.6\zh-Hans\Client\Content\Aki\ConfigDB\zh-Hans'); Target = 'analysis\extracted_3.6\zh-Hans\Client\Content\Aki\ConfigDB\zh-Hans' },
